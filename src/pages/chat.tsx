...
export default function ChatPage() {
  return (
    <div className="relative h-screen flex flex-col w-full dark:bg-neutral-900">
      <div className="w-full max-w-4xl py-8 mx-auto flex-grow">
        <ChatBubble />
      </div>
      <footer className="w-full max-w-4xl mx-auto sticky bottom-0 z-10 bg-white pt-2 pb-4 sm:pt-4 sm:pb-6 px-4 sm:px-6 lg:px-0 dark:bg-neutral-900 dark:border-neutral-700">
        ...
        {/* Input */}
        <div className="relative border dark:border-neutral-700 rounded-md">
          <textarea
            className="p-4 pb-12 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600 resize-none"
